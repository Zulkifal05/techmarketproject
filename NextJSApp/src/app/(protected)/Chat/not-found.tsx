  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-16 px-4">
      <div className="max-w-xl w-full bg-white border border-gray-200 rounded-3xl shadow-xl p-10 text-center">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Chat not found</h1>
        <p className="text-gray-600 mb-8">
          The chat you are looking for is unavailable. It may have been removed, the link may be incorrect, or the user no longer exists.
        </p>
        <Link
          href="/"
